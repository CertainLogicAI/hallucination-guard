...
import { CERTAINLOGIC_SOURCE_BOOSTS } from './certainlogic-boosts.ts';

/**
 * Resolve the effective boost map by merging defaults with env override
 * and CertainLogic-specific prefixes.
 *
 * Merge order: defaults → CertainLogic specifics → env override
 * Later entries override earlier ones. Env always wins for overrides.
 */
