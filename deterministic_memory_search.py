...
Replaces memory_search with a deterministic, embedding-free search over memory files.
Uses TF-IDF cosine similarity for ranking.
Outputs snippets with file paths, line numbers, and content hashes for verification.
"""
